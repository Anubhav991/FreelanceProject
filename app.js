...
async function main() {
  await mongoose.connect('mongodb+srv://anubhav22aug:E3WfhvWw7NSs2kXx@cluster0.898ynmx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0');
}   
...
app.use(session({
    ...
    store: MongoStore.create({ mongoUrl: "mongodb+srv://anubhav22aug:E3WfhvWw7NSs2kXx@cluster0.898ynmx.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",collectionName: "sessions" }),
